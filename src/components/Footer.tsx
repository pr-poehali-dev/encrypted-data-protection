        ...
        <div className="border-t border-border mt-16 pt-12 pb-4">
          <div className="text-center mb-8">
            <p className="text-muted-foreground text-sm font-mono italic mb-2">
              Это мой учебный проект за 10 класс — не судите строго 😅
            </p>
            <p className="text-xs font-mono text-muted-foreground/60 uppercase tracking-widest">Автор проекта</p>
          </div>
          <div className="flex justify-center">
            <div className="flex items-center gap-5 bg-background/50 border border-border rounded-2xl px-8 py-6 max-w-sm">
              ...
              <div>
                <p className="text-foreground font-bold text-lg" style={{ fontFamily: "var(--font-montserrat)" }}>Jaster Molbino</p>
                <p className="text-primary text-xs font-mono uppercase tracking-widest">Автор</p>
                <p className="text-muted-foreground text-xs font-mono">10 класс</p>
              </div>
            </div>
          </div>
        </div>
