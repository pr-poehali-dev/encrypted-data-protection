        ...
        <section className="mx-4 md:mx-0 mb-8 rounded-4xl border border-border bg-card px-8 py-8 flex gap-5 items-start">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              На этом сайте собраны <span className="text-foreground font-semibold">пять наиболее распространённых угроз</span>, с которыми чаще всего сталкиваются школьники и молодёжь в интернете. В реальности видов мошенничества гораздо больше: кража личности, кибербуллинг, телефонные мошенники и многое другое. Будь внимателен — и помни, что здоровый скептицизм в сети никогда не лишний.
            </p>
          </div>
        </section>
