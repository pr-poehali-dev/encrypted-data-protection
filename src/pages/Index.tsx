...
<div class="kb-wrap">
  ...
  <div style="background:#111;border:1px solid #222;border-radius:24px;padding:40px;margin-bottom:32px">
    ...
    <div class="kb-tips-grid">
      <div class="kb-tip" onclick="openModal('t1')"><div class="kb-tip-emoji">🔑</div><p>Уникальный пароль для каждого сайта</p><div style="font-size:11px;color:#00cfff;margin-top:8px;opacity:0.7">Подробнее →</div></div>
      <div class="kb-tip" onclick="openModal('t2')"><div class="kb-tip-emoji">📱</div><p>Двухфакторная аутентификация везде</p><div style="font-size:11px;color:#00cfff;margin-top:8px;opacity:0.7">Подробнее →</div></div>
      <div class="kb-tip" onclick="openModal('t3')"><div class="kb-tip-emoji">🔍</div><p>Проверяй адрес сайта перед вводом данных</p><div style="font-size:11px;color:#00cfff;margin-top:8px;opacity:0.7">Подробнее →</div></div>
      <div class="kb-tip" onclick="openModal('t4')"><div class="kb-tip-emoji">🚨</div><p>Не верь «срочным» сообщениям о призах</p><div style="font-size:11px;color:#00cfff;margin-top:8px;opacity:0.7">Подробнее →</div></div>
      <div class="kb-tip" onclick="openModal('t5')"><div class="kb-tip-emoji">🛡️</div><p>Не скачивай файлы с незнакомых сайтов</p><div style="font-size:11px;color:#00cfff;margin-top:8px;opacity:0.7">Подробнее →</div></div>
      <div class="kb-tip" onclick="openModal('t6')"><div class="kb-tip-emoji">🔒</div><p>Настрой приватность в соцсетях</p><div style="font-size:11px;color:#00cfff;margin-top:8px;opacity:0.7">Подробнее →</div></div>
      <div class="kb-tip" onclick="openModal('t7')"><div class="kb-tip-emoji">🧠</div><p>Останови себя перед тем как действовать</p><div style="font-size:11px;color:#00cfff;margin-top:8px;opacity:0.7">Подробнее →</div></div>
    </div>
  </div>
...
<div id="t1" class="kb-modal-overlay" onclick="if(event.target===this)closeModal('t1')"><div class="kb-modal" style="border-top:3px solid #00cfff"><button class="kb-modal-close" onclick="closeModal('t1')">×</button><div style="font-size:44px;margin-bottom:12px">🔑</div><h2 style="color:#00cfff">Уникальный пароль для каждого сайта</h2><div class="kb-modal-sub">САМАЯ ЧАСТАЯ ПРИЧИНА ВЗЛОМОВ — ОДИН ПАРОЛЬ НА ВСЁ</div><div class="kb-block"><div class="kb-label" style="color:#00cfff">💡 ЧТО ЭТО ЗНАЧИТ</div><p>Когда взламывают один сайт, хакеры получают список паролей и сразу проверяют их на всех популярных сервисах. Если ты используешь один пароль везде — достаточно одной утечки, чтобы потерять всё. Уникальный пароль на каждом сайте делает такую атаку бессмысленной.</p></div><div class="kb-block"><div class="kb-label" style="color:#00cfff">⚡ КАК СДЕЛАТЬ ПРЯМО СЕЙЧАС</div><ul style="list-style:none"><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Установи бесплатный менеджер паролей — Bitwarden или KeePass</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Он сам генерирует сложные пароли — тебе нужен только один мастер-пароль</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Начни с важных аккаунтов: почта, соцсети, банк</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Никогда не сохраняй пароли в заметках или текстовых файлах</li></ul></div><div class="kb-meme" style="border:1px solid rgba(0,207,255,0.2);background:rgba(0,207,255,0.05)"><span style="font-size:18px">💡</span> Среднестатистический пользователь имеет 100+ аккаунтов. Запомнить уникальные пароли без менеджера — невозможно.</div></div></div>
<div id="t2" class="kb-modal-overlay" onclick="if(event.target===this)closeModal('t2')"><div class="kb-modal" style="border-top:3px solid #00cfff"><button class="kb-modal-close" onclick="closeModal('t2')">×</button><div style="font-size:44px;margin-bottom:12px">📱</div><h2 style="color:#00cfff">Двухфакторная аутентификация везде</h2><div class="kb-modal-sub">ДАЖЕ ЗНАЯ ПАРОЛЬ, ХАКЕР НЕ ВОЙДЁТ БЕЗ ВТОРОГО ПОДТВЕРЖДЕНИЯ</div><div class="kb-block"><div class="kb-label" style="color:#00cfff">💡 ЧТО ЭТО ЗНАЧИТ</div><p>2FA — дополнительный слой защиты. После ввода пароля сервис запрашивает одноразовый код из смс или приложения. Даже если мошенник узнал твой пароль — без твоего телефона он не войдёт.</p></div><div class="kb-block"><div class="kb-label" style="color:#00cfff">⚡ КАК СДЕЛАТЬ ПРЯМО СЕЙЧАС</div><ul style="list-style:none"><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Зайди в настройки безопасности ВКонтакте, почты, игровых платформ</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Найди «Двухфакторная аутентификация» или «Подтверждение входа»</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Установи Google Authenticator или Яндекс Ключ</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Включи 2FA хотя бы на почте — через неё восстанавливаются все аккаунты</li></ul></div><div class="kb-meme" style="border:1px solid rgba(0,207,255,0.2);background:rgba(0,207,255,0.05)"><span style="font-size:18px">💡</span> По данным Microsoft, 2FA блокирует 99,9% автоматизированных атак на аккаунты.</div></div></div>
<div id="t3" class="kb-modal-overlay" onclick="if(event.target===this)closeModal('t3')"><div class="kb-modal" style="border-top:3px solid #00cfff"><button class="kb-modal-close" onclick="closeModal('t3')">×</button><div style="font-size:44px;margin-bottom:12px">🔍</div><h2 style="color:#00cfff">Проверяй адрес сайта перед вводом данных</h2><div class="kb-modal-sub">ФИШИНГОВЫЕ САЙТЫ ВЫГЛЯДЯТ ИДЕНТИЧНО — РАЗНИЦА ТОЛЬКО В АДРЕСЕ</div><div class="kb-block"><div class="kb-label" style="color:#00cfff">💡 ЧТО ЭТО ЗНАЧИТ</div><p>Мошенники создают точные копии сайтов. Единственное, что нельзя подделать — адрес в строке браузера. Настоящий ВКонтакте — только vk.com. Не vk-login.ru, не vk.com.secure-login.ru — только vk.com.</p></div><div class="kb-block"><div class="kb-label" style="color:#00cfff">⚡ КАК СДЕЛАТЬ ПРЯМО СЕЙЧАС</div><ul style="list-style:none"><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Перед вводом логина/пароля всегда смотри на адресную строку</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Проверяй наличие замочка (https)</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Сохрани важные сайты в закладки и заходи только через них</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ При сомнениях — закрой вкладку и открой сайт вручную</li></ul></div><div class="kb-meme" style="border:1px solid rgba(0,207,255,0.2);background:rgba(0,207,255,0.05)"><span style="font-size:18px">💡</span> Большинство фишинговых сайтов существуют меньше 24 часов.</div></div></div>
<div id="t4" class="kb-modal-overlay" onclick="if(event.target===this)closeModal('t4')"><div class="kb-modal" style="border-top:3px solid #00cfff"><button class="kb-modal-close" onclick="closeModal('t4')">×</button><div style="font-size:44px;margin-bottom:12px">🚨</div><h2 style="color:#00cfff">Не верь «срочным» сообщениям о призах</h2><div class="kb-modal-sub">СРОЧНОСТЬ И ЖАДНОСТЬ — ГЛАВНЫЕ ИНСТРУМЕНТЫ МОШЕННИКОВ</div><div class="kb-block"><div class="kb-label" style="color:#00cfff">💡 ЧТО ЭТО ЗНАЧИТ</div><p>«Ты выиграл!», «Аккаунт заблокируют через час!», «Только сегодня!» — всё это создаёт панику и спешку. Когда человек торопится, он не думает критически. Мошенники специально создают это давление.</p></div><div class="kb-block"><div class="kb-label" style="color:#00cfff">⚡ КАК СДЕЛАТЬ ПРЯМО СЕЙЧАС</div><ul style="list-style:none"><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Сообщение требует немедленных действий — это красный флаг, притормози</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Настоящие призы не исчезают через 5 минут</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Загугли название + «мошенники» или «развод»</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Спроси взрослого — взгляд со стороны помогает увидеть обман</li></ul></div><div class="kb-meme" style="border:1px solid rgba(0,207,255,0.2);background:rgba(0,207,255,0.05)"><span style="font-size:18px">💡</span> Люди в спешке в 3 раза чаще совершают ошибки при оценке информации в интернете.</div></div></div>
<div id="t5" class="kb-modal-overlay" onclick="if(event.target===this)closeModal('t5')"><div class="kb-modal" style="border-top:3px solid #00cfff"><button class="kb-modal-close" onclick="closeModal('t5')">×</button><div style="font-size:44px;margin-bottom:12px">🛡️</div><h2 style="color:#00cfff">Не скачивай файлы с незнакомых сайтов</h2><div class="kb-modal-sub">БОЛЬШИНСТВО ВИРУСОВ ПОПАДАЮТ ЧЕРЕЗ СКАЧАННЫЕ ФАЙЛЫ</div><div class="kb-block"><div class="kb-label" style="color:#00cfff">💡 ЧТО ЭТО ЗНАЧИТ</div><p>Читы, моды, «взломанные» игры, бесплатные версии платных программ — излюбленные способы распространения вирусов. Один скачанный файл может стоить всех паролей и данных.</p></div><div class="kb-block"><div class="kb-label" style="color:#00cfff">⚡ КАК СДЕЛАТЬ ПРЯМО СЕЙЧАС</div><ul style="list-style:none"><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Скачивай только с официальных сайтов разработчиков</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Моды — только с CurseForge, Modrinth, Steam Workshop</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Проверь файл на VirusTotal.com перед запуском</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Не отключай антивирус если программа «просит» — это красный флаг</li></ul></div><div class="kb-meme" style="border:1px solid rgba(0,207,255,0.2);background:rgba(0,207,255,0.05)"><span style="font-size:18px">💡</span> 60% заражений у подростков — через читы, моды и торрент-загрузки.</div></div></div>
<div id="t6" class="kb-modal-overlay" onclick="if(event.target===this)closeModal('t6')"><div class="kb-modal" style="border-top:3px solid #00cfff"><button class="kb-modal-close" onclick="closeModal('t6')">×</button><div style="font-size:44px;margin-bottom:12px">🔒</div><h2 style="color:#00cfff">Настрой приватность в соцсетях</h2><div class="kb-modal-sub">ОТКРЫТЫЙ ПРОФИЛЬ — ГОТОВАЯ МИШЕНЬ ДЛЯ МОШЕННИКОВ</div><div class="kb-block"><div class="kb-label" style="color:#00cfff">💡 ЧТО ЭТО ЗНАЧИТ</div><p>Публичный профиль с именем, школой, городом и фото — готовая база данных для злоумышленников. Они используют эти данные для фишинга, шантажа и целевой социальной инженерии.</p></div><div class="kb-block"><div class="kb-label" style="color:#00cfff">⚡ КАК СДЕЛАТЬ ПРЯМО СЕЙЧАС</div><ul style="list-style:none"><li style="color:#aaa;font-size:13px;padding:4px 0">▸ ВКонтакте: Настройки → Приватность → «Только друзья»</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Убери из профиля школу, адрес и телефон</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Ограничь кто может писать тебе — только друзья</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Не принимай заявки от незнакомых людей</li></ul></div><div class="kb-meme" style="border:1px solid rgba(0,207,255,0.2);background:rgba(0,207,255,0.05)"><span style="font-size:18px">💡</span> 80% таргетированных атак используют информацию из открытых профилей жертвы.</div></div></div>
<div id="t7" class="kb-modal-overlay" onclick="if(event.target===this)closeModal('t7')"><div class="kb-modal" style="border-top:3px solid #00cfff"><button class="kb-modal-close" onclick="closeModal('t7')">×</button><div style="font-size:44px;margin-bottom:12px">🧠</div><h2 style="color:#00cfff">Останови себя перед тем как действовать</h2><div class="kb-modal-sub">КРИТИЧЕСКОЕ МЫШЛЕНИЕ — ГЛАВНОЕ ОРУЖИЕ ПРОТИВ МОШЕННИКОВ</div><div class="kb-block"><div class="kb-label" style="color:#00cfff">💡 ЧТО ЭТО ЗНАЧИТ</div><p>Все схемы мошенников работают на одном принципе: заставить действовать быстро, не думая. Паника, жадность, страх — отключают критическое мышление. Правило «пауза на 10 секунд» спасает от большинства угроз.</p></div><div class="kb-block"><div class="kb-label" style="color:#00cfff">⚡ КАК СДЕЛАТЬ ПРЯМО СЕЙЧАС</div><ul style="list-style:none"><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Перед важным действием спроси себя: «А это точно настоящее?»</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Сильные эмоции (приз, страх, угроза) — сигнал притормозить</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Посоветуйся с другом или родителем прежде чем действовать</li><li style="color:#aaa;font-size:13px;padding:4px 0">▸ Настоящие ситуации почти никогда не требуют решения за 5 минут</li></ul></div><div class="kb-meme" style="border:1px solid rgba(0,207,255,0.2);background:rgba(0,207,255,0.05)"><span style="font-size:18px">💡</span> Осознанная пауза снижает вероятность стать жертвой мошенничества на 70%.</div></div></div>
